...
public class Location4JDataAnalyser {
  ...
  public static void main(String[] args) throws Exception {
	...
	System.out.println(
		"Total states: " + countries.stream().mapToInt(c -> c.getStates().size()).sum());
	...
	System.out.println("=".repeat(80));
	System.out.println(
		"- CRITICAL and HIGH severity clashes may cause ambiguity in location search");
	System.out.println(
		"- LOW severity clashes (State + City) are common and usually resolved by context");
